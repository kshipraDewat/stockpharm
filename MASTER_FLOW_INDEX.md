...
> Full definitions live in [`UNIFIED_FEATURES.md`](./UNIFIED_FEATURES.md) (Part I + Appendices A–H). Per-app analysis files in [`_reviews/`](./_reviews/).
...
| [`MERGED_REVIEWS.md`](./MERGED_REVIEWS.md) | **All reviews merged** — Part I unified map + Part II full per-app reviews + API index |
| [`UNIFIED_FEATURES.md`](./UNIFIED_FEATURES.md) | Same merge content (canonical spec; keep in sync with `_reviews/`) |
| [`_reviews/review-*.md`](./_reviews/) | **One exhaustive review per app** — edit individually, then regenerate merge |
